...
// GridLayout-Komponente
const GridLayout = ({ activeLayout, setActiveLayout }) => {
...
// Filter-Komponente
const Filter = ({ onCategoryChange, onCardTypeChange }) => {
  ...
  return (
    <div id="filter-section">
      {/* GridLayout-Komponente hier einfügen und activeLayout & setActiveLayout weitergeben */}
      <GridLayout activeLayout={activeLayout} setActiveLayout={setActiveLayout} />
